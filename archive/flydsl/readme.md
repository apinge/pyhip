...
========================================================================================================================
op         shape              dtype  FlyDSL(gpu us) AIter triton(us) aiter.rms_norm(us)
rmsnorm    32768x8192         f16             823.5          1,215.7            1,224.3
rmsnorm    32768x4096         f16             438.7            832.1              428.7
rmsnorm    8000x4096          f16             131.5            207.4               89.6
rmsnorm    8x4096             f16              21.1             50.9                8.9
rmsnorm    4x4096             f16              22.5             52.9                9.0
rmsnorm    2x4096             f16              20.8             50.6                8.9
rmsnorm    32768x4096         bf16            418.6          1,061.6              565.1
rmsnorm    8000x4096          bf16            121.8            261.8              126.6
rmsnorm    8x4096             bf16             22.2             50.7                9.3
rmsnorm    4x4096             bf16             21.0             59.4               10.9
rmsnorm    2x4096             bf16             21.8             50.2                8.8
=====================================================================================================================
```